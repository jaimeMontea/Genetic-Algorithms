...
#    childGenes = parent.Genes[:]
#    
#    if len(childGenes) == len(set(childGenes)):
#        indexA, indexB = random.sample(range(len(childGenes)), 2)
#        childGenes[indexA], childGenes[indexB] = childGenes[indexB], childGenes[indexA]
#    else:
#        indexA = random.randrange(0, len(childGenes))
#        indexB = random.randrange(0, len(geneSet))
#        childGenes[indexA] = geneSet[indexB]
#
#    
#    fitness = get_fitness(childGenes)
#    return Chromosome(childGenes, fitness)
